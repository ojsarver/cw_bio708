...
# 10 individuals from a population sampling -------------------------------
...
#histogram for BIASED variance - biased because variance calculated from such a
#small sample
...
#layout vertically, only possible only if "patchwork" is loaded
g_mu / g_var


# redo simulations but we will use unbiased var
...
for (i in 1:100) {
  ...
  var_ub_i[i] <- var(df_i$height) #unbiased var uses var() function
}
